	...
	public void initFrame() {
		...
		startTask1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//try {
					//dos.writeInt(1);
					AbstractRequest request = runner.createRequest(CheckAuthRequest.class, runner.getClientID());
					request.getResponseMapper().setUIProxy(new RespondSuccessMessage(Frame2.this,"Авторизация пройдена"));
